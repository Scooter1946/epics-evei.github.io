Read Trent Jerome's Work and Accomplishments for Fall 2022 for information about the website.
 ...
 - Used Eclipse IDE for programming
 
 - To update website
  1. Open index.html file on GitHub
  2. Edit file by clicking on the pen icon in top right
  3. Hit commit changes at bottom
  4. You can click on "Actions" Tab to see the upload progress
